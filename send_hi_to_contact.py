#!/usr/bin/env python3
"""
Script to send "hi" message to +923349739727 using the provided credentials.
"""
...
def send_hi_message():
    """
    Send "hi" message to +923349739727 using the provided credentials.
    """
...
if __name__ == "__main__":
    print("Sending 'hi' message to +923349739727...")
    success = send_hi_message()
